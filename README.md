...
Los siguientes scripts pueden ser ejecutados para visualizar y analizar los resultados de la predicción para la limpieza de secuencias crudas de Theobroma cacao:

* score_visualization
* results
* extract_cacao_predictions
